...
{{-- <img class="center-block mt-5" src="data:image/png;base64,{{DNS2D::getBarcodePNG($data->zatca_qr_text(), 'QRCODE')}}">   --}}
</div>   
...
right: 128px;" />
  ...
  <div style="text-align: center;">
    <h1 style="position: relative;right: 171;">Received Voucher</h1>
  </div>
...
<tr>
    ...
    <tr>
      ...
      <td colspan="3">{{$data->customer->get_balance_status()}}</td>
    </tr>
    <tr>
