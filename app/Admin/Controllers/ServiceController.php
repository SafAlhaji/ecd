...
class ServiceController extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->model()->where('request_type_id', RequestType::Embassy);
        ...
        $grid->column('Professions')->expand(function ($model) {
    ...
    protected function form()
    {
        ...
        $form->hidden('request_type_id', 'Request Type')->value(RequestType::Embassy);
        ...
        $form->hasMany('servicedetails', 'Embassy charge details', function (Form\NestedForm $form) {
            ...
            $form->currency('embassy_charge', trans('service.fields.embassy_charge'))->rules('min:1|required');
        })->useTable();
